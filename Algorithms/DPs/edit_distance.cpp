...
int edit_distance_min(const string& from, const string& to, const int addition_cost = 1, const int editting_cost = 1, const int deletion_cost = 1, const bool _debug = false) {
  int i, j;
  ...
  if (_debug) {
    out_matrix_int(vect, "edit_distance()[ vect ]");
    out_int(ans, "edit_distance()");
  }
...
vector<pair<char, char>> edit_distance_string(const string& from, const string& to, const int addition_cost = 1, const int editting_cost = 1, const int deletion_cost = 1, const bool _debug = false) {
  ...
  if (_debug) {
    out_matrix_int(vect, "edit_distance()[ vect ]");
    out_transtion_char_char(ans, "edit_distance()");
  }
